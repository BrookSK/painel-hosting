...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-logo">
    ...
    <button class="sidebar-toggle" id="sidebarToggle" title="<?php echo View::e(I18n::t('geral.recolher_menu')); ?>" aria-label="<?php echo View::e(I18n::t('geral.recolher_menu')); ?>" onclick="(function(){var s=document.getElementById('appShell');if(s){s.classList.toggle('collapsed');localStorage.setItem('lrv_sidebar_collapsed',s.classList.contains('collapsed')?'1':'0');}})()">
