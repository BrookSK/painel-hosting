...
var FLOW={
  ...
  wp_migracao:{msg:'Nosso migrador automático funciona assim:\n\n1. Você informa o IP, senha SSH e caminho do WordPress no servidor atual\n2. Informa os dados do banco MySQL (nome, usuário, senha)\n3. O sistema conecta servidor-a-servidor e copia tudo via rsync + mysqldump\n4. O WordPress é configurado automaticamente no nosso servidor\n\nFunciona com AAPanel, cPanel ou qualquer servidor com SSH. Sites pesados (10GB, 50GB+) migram sem problema — não precisa fazer zip nem backup manual.',opts:[
    {l:LOGADO?'<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/></svg> Migrar agora':'<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/></svg> Criar conta para migrar',a:function(){window.location.href=LOGADO?'/cliente/migracoes-wp/novo':'/cliente/criar-conta';}},
    {l:'<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg> Falar com atendente',n:'escalate'},
    {l:'← Voltar',n:'wordpress'}
  ]},
  ...
  deploy:{msg:'O Git Deploy permite subir seu projeto do GitHub/GitLab direto no servidor. Basta conectar o repositório, configurar a branch e clicar em Deploy. Também temos Auto Deploy (atualiza sozinho a cada git push).',opts:[
    {l:'🚀 Como conectar meu repositório?',n:'git_conectar'},{l:'🔑 Como configurar a Deploy Key?',n:'git_deploykey'},{l:'🔄 Como ativar o Auto Deploy?',n:'git_autodeploy'},{l:'⚙️ Configurações (PHP, Node, etc.)',n:'git_config'},{l:'📖 Ver tutorial completo',a:function(){window.location.href='/cliente/ajuda';}},{l:'← Voltar',n:'start'}
  ]},
  git_conectar:{msg:'Passo a passo para conectar um repositório:\n\n1. Vá em Git Deploy no menu lateral\n2. Clique em "+ Novo repositório"\n3. Preencha o nome (ex: "Meu Site")\n4. Selecione sua VPS\n5. Cole a URL do repositório (no GitHub: botão verde "Code" → copie a URL HTTPS)\n6. Informe a branch (geralmente "main")\n7. Escolha um subdomínio ou gere um domínio temporário\n8. Escolha o tipo de app (PHP, Node.js, Python, etc.)\n9. Clique em Salvar\n\nDepois de salvar, copie a Deploy Key e adicione no GitHub (veja o próximo passo).',opts:[
    {l:'🔑 Como adicionar a Deploy Key?',n:'git_deploykey'},{l:'← Voltar',n:'deploy'}
  ]},
  git_deploykey:{msg:'A Deploy Key permite nosso servidor acessar seu código no GitHub:\n\n1. Após salvar o repositório, copie a Deploy Key que aparece na tela de edição\n2. No GitHub, vá no repositório → Settings → Deploy keys → Add deploy key\n3. Cole a chave, dê um título (ex: "LRV Cloud") e salve\n\nSe o repositório for público, não precisa fazer isso. No GitLab: Settings → Repository → Deploy keys.',opts:[
    {l:'🔄 Como ativar Auto Deploy?',n:'git_autodeploy'},{l:'← Voltar',n:'deploy'}
  ]},
  git_autodeploy:{msg:'O Auto Deploy faz o servidor atualizar sozinho toda vez que você der git push:\n\n1. Na edição do repositório, marque "Auto Deploy" e salve\n2. Copie a URL do Webhook que aparece\n3. No GitHub: Settings → Webhooks → Add webhook\n4. Cole a URL em "Payload URL"\n5. Content type: application/json\n6. Evento: Just the push event\n7. Salve\n\nPronto! Agora cada git push na branch configurada dispara o deploy automaticamente.',opts:[
    {l:'⚙️ Outras configurações',n:'git_config'},{l:'← Voltar',n:'deploy'}
  ]},
  git_config:{msg:'Configurações disponíveis no Git Deploy:\n\n• Substituir tudo (force overwrite): descarta alterações locais e mantém igual ao GitHub. Recomendado.\n• Comando pós-deploy: roda após cada deploy (ex: npm install, composer install)\n• PHP: versão, memory_limit, upload_max\n• Node.js/Python: porta da aplicação\n• Console: execute comandos na pasta do projeto direto pelo painel\n\nTudo isso fica na tela de edição do repositório.',opts:[
    {l:'📖 Ver tutorial completo',a:function(){window.location.href='/cliente/ajuda';}},{l:'← Voltar',n:'deploy'}
  ]},
  armazenamento:{msg:'A tela de Armazenamento mostra quanto espaço cada projeto, aplicação e arquivo ocupa no seu servidor. Você pode:\n\n• Escanear o disco para ver o uso em tempo real\n• Ver o tamanho de cada app/deploy individualmente\n• Limpar arquivos temporários, logs antigos e caches\n• Apagar projetos inteiros que não usa mais\n\nAcesse pelo menu lateral → Armazenamento.',opts:[
    {l:'📦 Abrir Armazenamento',a:function(){window.location.href='/cliente/armazenamento';}},{l:'← Voltar',n:'start'}
  ]},
