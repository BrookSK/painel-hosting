...
<header class="app-header">
  <div class="header-left">
    <button class="sidebar-expand-btn" id="sidebarExpandBtn" aria-label="<?php echo View::e(I18n::t('geral.expandir_menu')); ?>" title="<?php echo View::e(I18n::t('geral.expandir_menu')); ?>">
