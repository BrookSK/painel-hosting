...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    <a href="/cliente/painel" class="nav-item<?php echo _nav_ativo_cli('/cliente/painel', $_seg); ?>" data-tooltip="Painel">
    ...
    <a href="/cliente/vps" class="nav-item<?php echo _nav_ativo_cli('/cliente/vps', $_seg); ?>" data-tooltip="VPS">
    ...
    <a href="/cliente/monitoramento" class="nav-item<?php echo _nav_ativo_cli('/cliente/monitoramento', $_seg); ?>" data-tooltip="Monitoramento">
    ...
    <a href="/cliente/tickets" class="nav-item<?php echo _nav_ativo_cli('/cliente/tickets', $_seg); ?>" data-tooltip="Tickets">
    ...
    <a href="/cliente/chat" class="nav-item<?php echo _nav_ativo_cli('/cliente/chat', $_seg); ?>" data-tooltip="Chat">
    ...
    <a href="/cliente/emails" class="nav-item<?php echo _nav_ativo_cli('/cliente/emails', $_seg); ?>" data-tooltip="E-mails">
    ...
    <a href="/cliente/aplicacoes" class="nav-item<?php echo _nav_ativo_cli('/cliente/aplicacoes', $_seg); ?>" data-tooltip="Aplicações">
    ...
    <a href="/cliente/ajuda" class="nav-item<?php echo _nav_ativo_cli('/cliente/ajuda', $_seg); ?>" data-tooltip="Ajuda">
  ...
  <div class="sidebar-footer">
    <a href="/cliente/minha-conta" class="nav-item<?php echo _nav_ativo_cli('/cliente/minha-conta', $_seg); ?>" data-tooltip="Minha Conta">
