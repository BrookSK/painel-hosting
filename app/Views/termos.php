...
<head>
  ...
  <?php $seo_titulo = I18n::t('termos.titulo') . ' — ' . ($nome_sistema ?? SistemaConfig::nome()); require __DIR__ . '/_partials/seo.php'; ?>
...
<body>
  ...
  <div class="pub-page-hero">
    <div class="pub-page-hero-inner">
      <div class="pub-page-label"><?php echo View::e(I18n::t('termos.label')); ?></div>
      <h1 class="pub-page-title"><?php echo View::e(I18n::t('termos.titulo')); ?></h1>
      <p class="pub-page-sub"><?php echo View::e(I18n::t('termos.sub')); ?></p>
    </div>
  </div>
  ...
  <div class="legal-wrap">
    <div class="legal-body">
      <?php if (!empty($conteudo)): ?>
        <?php echo $conteudo; ?>
      <?php else: ?>
        <h1><?php echo View::e(I18n::t('termos.titulo')); ?></h1>
        <p><?php echo View::e(I18n::t('termos.vazio')); ?></p>
      <?php endif; ?>
    </div>
  </div>
