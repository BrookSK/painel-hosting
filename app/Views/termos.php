...
<head>
  ...
  <title>Termos de Uso — <?php echo View::e($nome_sistema ?? SistemaConfig::nome()); ?></title>
  <?php $seo_titulo = 'Termos de Uso — ' . ($nome_sistema ?? SistemaConfig::nome()); require __DIR__ . '/_partials/seo.php'; ?>
...
<body>
  ...
  <div class="pub-page-hero">
    <div class="pub-page-hero-inner">
      ...
      <h1 class="pub-page-title">Termos de Uso</h1>
      <p class="pub-page-sub">Leia com atenção os termos que regem o uso da plataforma.</p>
    </div>
  </div>
