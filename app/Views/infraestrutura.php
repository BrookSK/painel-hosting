...
<section class="section" id="produtos">
  <div class="section-inner">
    <div class="section-label"><?php echo View::e(I18n::t('infra.products_label')); ?></div>
    <h2 class="section-title"><?php echo View::e(I18n::t('infra.products_titulo')); ?></h2>
    <p class="section-sub"><?php echo View::e(I18n::t('infra.products_sub')); ?></p>
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:20px;margin-top:40px;">
      <?php
        $produtos = [
          ['/solucoes/vps',       '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>', I18n::t('infra.prod_vps_name'),       I18n::t('infra.prod_vps_desc'),       '#4F46E5'],
          ['/solucoes/wordpress', '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>', I18n::t('infra.prod_wp_name'), I18n::t('infra.prod_wp_desc'),                  '#1d4ed8'],
          ['/solucoes/webhosting','<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>', I18n::t('infra.prod_wh_name'),          I18n::t('infra.prod_wh_desc'),            '#16a34a'],
          ['/solucoes/nodejs',    '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1.5l9.5 5.5v11L12 23.5 2.5 18V7z"/></svg>',  I18n::t('infra.prod_node_name'),          I18n::t('infra.prod_node_desc'),                     '#d97706'],
          ['/solucoes/php',       '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>', I18n::t('infra.prod_php_name'),        I18n::t('infra.prod_php_desc'),                        '#ea580c'],
          ['/solucoes/python',    '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/><line x1="12" y1="2" x2="12" y2="22"/></svg>', I18n::t('infra.prod_python_name'),           I18n::t('infra.prod_python_desc'),                        '#0891b2'],
          ['/solucoes/cpp',       '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09a1.65 1.65 0 0 0-1.08-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09a1.65 1.65 0 0 0 1.51-1.08 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1.08 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1.08z"/></svg>', I18n::t('infra.prod_cpp_name'),            I18n::t('infra.prod_cpp_desc'),             '#db2777'],
          ['/solucoes/aplicacoes','<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"/><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>', I18n::t('infra.prod_deploy_name'),    I18n::t('infra.prod_deploy_desc'),               '#8b5cf6'],
          ['/solucoes/email',     '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>', I18n::t('infra.prod_email_name'),          I18n::t('infra.prod_email_desc'),                      '#e11d48'],
          ['/solucoes/devops',    '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>', I18n::t('infra.prod_devops_name'), I18n::t('infra.prod_devops_desc'),              '#059669'],
          ['/solucoes/seguranca', '<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>', I18n::t('infra.prod_sec_name'),            I18n::t('infra.prod_sec_desc'),                    '#334155'],
        ];
      ...
      <a href="<?php echo $href; ?>" style="background:#fff;border:2px solid #e2e8f0;border-radius:16px;padding:24px;text-decoration:none;color:inherit;display:flex;flex-direction:column;gap:10px;transition:all .2s;"
        ...
        <div style="font-size:12px;font-weight:600;color:<?php echo $color; ?>;margin-top:auto;"><?php echo View::e(I18n::t('infra.prod_more')); ?></div>
      </a>
      <?php endforeach; ?>
    </div>
  </div>
...
<section class="section dark" id="tecnologia">
  <div class="section-inner">
    ...
    <div class="tech-grid">
      <div class="tech-card"><div class="tech-card-icon"><svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg></div><div class="tech-card-name"><?php echo View::e(I18n::t('infra.tech_php')); ?></div><div class="tech-card-desc"><?php echo View::e(I18n::t('infra.tech_php_desc')); ?></div></div>
      <div class="tech-card"><div class="tech-card-icon"><svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg></div><div class="tech-card-name"><?php echo View::e(I18n::t('infra.tech_mysql')); ?></div><div class="tech-card-desc"><?php echo View::e(I18n::t('infra.tech_mysql_desc')); ?></div></div>
      <div class="tech-card"><div class="tech-card-icon"><svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><rect x="5" y="10" width="4" height="4"/><rect x="11" y="10" width="4" height="4"/><line x1="2" y1="4" x2="7" y2="4"/></svg></div><div class="tech-card-name"><?php echo View::e(I18n::t('infra.tech_docker')); ?></div><div class="tech-card-desc"><?php echo View::e(I18n::t('infra.tech_docker_desc')); ?></div></div>
      <div class="tech-card"><div class="tech-card-icon"><svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg></div><div class="tech-card-name"><?php echo View::e(I18n::t('infra.tech_ws')); ?></div><div class="tech-card-desc"><?php echo View::e(I18n::t('infra.tech_ws_desc')); ?></div></div>
      <div class="tech-card"><div class="tech-card-icon"><svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div><div class="tech-card-name"><?php echo View::e(I18n::t('infra.tech_sec')); ?></div><div class="tech-card-desc"><?php echo View::e(I18n::t('infra.tech_sec_desc')); ?></div></div>
      <div class="tech-card"><div class="tech-card-icon"><svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="22,7 12,13 2,7"/></svg></div><div class="tech-card-name"><?php echo View::e(I18n::t('infra.tech_mail')); ?></div><div class="tech-card-desc"><?php echo View::e(I18n::t('infra.tech_mail_desc')); ?></div></div>
    </div>
  </div>
</section>
