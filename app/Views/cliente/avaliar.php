...
<div style="margin-bottom:24px;">
  ...
  <div class="page-subtitle" style="margin-bottom:0;"><?php echo View::e($_tipo_label); ?></div>
</div>
...
<div class="card-new" style="max-width:560px;">
  ...
  <?php else: ?>
    <div class="card-new-title" style="margin-bottom:6px;">Avalie o atendimento</div>
    <p style="font-size:13px;color:#64748b;margin-bottom:20px;">Sua opinião nos ajuda a melhorar. Leva menos de 30 segundos.</p>
    ...
    (function(){
      ...
      btn.addEventListener('click',function(){
        ...
        fetch('/cliente/avaliar',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},
          ...
          if(j.ok){document.getElementById('avaliacao-form').innerHTML='<div class="sucesso" style="font-size:15px;">Obrigado! Sua avaliacao foi registrada.</div>';}
          else{document.getElementById('feedbackMsg').textContent=j.erro||'Erro ao enviar.';document.getElementById('feedbackMsg').style.color='#ef4444';btn.disabled=false;btn.textContent='Enviar avaliacao';}
        }).catch(function(){document.getElementById('feedbackMsg').textContent='Erro de rede.';document.getElementById('feedbackMsg').style.color='#ef4444';btn.disabled=false;btn.textContent='Enviar avaliacao';});
      });
    })();
    </script>
  <?php endif; ?>
