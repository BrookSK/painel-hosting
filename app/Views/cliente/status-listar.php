...
<body>
  <div class="topo">
    <div class="conteudo linha" style="justify-content:space-between;">
      <div>
        ...
        <div style="opacity:.9; font-size:13px;">Disponibilidade das suas VPS</div>
      </div>
      <div class="linha">
  ...
  <div class="conteudo">
    <div class="card" style="margin-bottom:14px;">
      <h2 class="titulo" style="font-size:16px; margin-bottom:12px;">Suas VPS</h2>
        ...
        <table style="width:100%; border-collapse:collapse;">
          ...
          <tbody>
            ...
            <?php if (empty($servicesArr)): ?>
              <tr>
                <td colspan="5" style="padding:12px;">Sem dados ainda.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
