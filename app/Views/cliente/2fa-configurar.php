...
<div class="page-subtitle" style="margin-bottom:20px;">Proteja sua conta com TOTP (Google Authenticator, Authy, etc.)</div>
...
<div class="card-new" style="max-width:520px;">
  ...
  <div style="border-top:1px solid #f1f5f9;padding-top:16px;">
    ...
    <p style="font-size:13px;color:#64748b;margin-bottom:12px;">Para desativar, confirme com o código do seu autenticador.</p>
    <form method="post" action="/cliente/2fa/desativar">
      ...
      <input class="input" type="text" name="codigo" maxlength="6" pattern="\d{6}" autocomplete="one-time-code"
             placeholder="000000" required inputmode="numeric"
             style="max-width:180px;letter-spacing:4px;font-size:18px;text-align:center;" />
...
<div class="card-new" style="max-width:520px;">
  ...
  <p style="font-size:13px;color:#64748b;margin-bottom:20px;">Escaneie o QR code com seu aplicativo autenticador ou insira a chave manualmente.</p>
  ...
  <div style="display:flex;gap:20px;align-items:flex-start;flex-wrap:wrap;margin-bottom:20px;">
    ...
    <div style="flex:1;min-width:200px;">
      ...
      <div style="font-size:12px;color:#64748b;line-height:1.5;">Use Google Authenticator, Authy, Bitwarden ou qualquer app TOTP compatível.</div>
    </div>
  </div>

  <div style="border-top:1px solid #f1f5f9;padding-top:16px;">
    <form method="post" action="/cliente/2fa/ativar">
      <input type="hidden" name="_csrf" value="<?php echo View::e(\LRV\Core\Csrf::token()); ?>" />
