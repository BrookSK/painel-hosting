    ...
    <div class="hero__visual">
      <div class="hero__server-card">
        ...
        <div class="server-specs">
          ...
          <div class="spec-item"><div class="spec-item__val"><?php echo View::e(I18n::t('home.infra_label')); ?></div><div class="spec-item__key"><?php echo View::e(I18n::t('home.infra_dedicada')); ?></div></div>
        </div>
      ...
      <div class="carousel-wrapper">
        <div class="carousel-track" id="carouselTrack">
          ...
          <div class="plan-card" style="border-color:#4F46E5;background:linear-gradient(180deg,#fff 0%,#f5f3ff 100%);">
            <div class="plan-badge" style="background:linear-gradient(135deg,#0B1C3D,#4F46E5);"><?php echo View::e(I18n::t('home.plans_custom_badge')); ?></div>
            <div class="plan-name"><?php echo View::e(I18n::t('home.plans_custom_name')); ?></div>
            <div class="plan-desc"><?php echo View::e(I18n::t('home.plans_custom_desc')); ?></div>
            <div class="plan-price" style="margin:16px 0;">
              <span style="font-size:16px;color:#4F46E5;font-weight:700;"><?php echo View::e(I18n::t('home.plans_custom_price')); ?></span>
            </div>
            <ul class="plan-specs" style="list-style:none;padding:0;margin:0 0 16px;font-size:13px;color:#475569;display:flex;flex-direction:column;gap:8px;">
              <li style="display:flex;align-items:center;gap:8px;"><span style="color:#4F46E5;">✓</span> <?php echo View::e(I18n::t('home.plans_custom_f1')); ?></li>
              <li style="display:flex;align-items:center;gap:8px;"><span style="color:#4F46E5;">✓</span> <?php echo View::e(I18n::t('home.plans_custom_f2')); ?></li>
              <li style="display:flex;align-items:center;gap:8px;"><span style="color:#4F46E5;">✓</span> <?php echo View::e(I18n::t('home.plans_custom_f3')); ?></li>
              <li style="display:flex;align-items:center;gap:8px;"><span style="color:#4F46E5;">✓</span> <?php echo View::e(I18n::t('home.plans_custom_f4')); ?></li>
            </ul>
            <div style="margin-top:auto;display:flex;flex-direction:column;gap:8px;">
              <a href="https://wa.me/5517988093160?text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20planos%20personalizados" target="_blank" class="plan-cta" style="display:flex;align-items:center;justify-content:center;gap:8px;background:#25D366;border-color:#25D366;">
                ...
                <?php echo View::e(I18n::t('home.plans_custom_wa')); ?>
              </a>
              <a href="mailto:<?php echo View::e(\LRV\Core\ConfiguracoesSistema::emailAdmin()); ?>?subject=Plano%20Personalizado" style="display:flex;align-items:center;justify-content:center;gap:8px;padding:12px 20px;border-radius:12px;font-size:14px;font-weight:600;color:#4F46E5;border:2px solid #e2e8f0;text-decoration:none;transition:border-color .15s;" onmouseover="this.style.borderColor='#4F46E5'" onmouseout="this.style.borderColor='#e2e8f0'">
                <svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="22,7 12,13 2,7"/></svg> <?php echo View::e(I18n::t('home.plans_custom_email')); ?>
              </a>
            </div>
          </div>
