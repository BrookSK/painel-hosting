...
@media(max-width:900px){.hero__inner{grid-template-columns:1fr;padding-bottom:60px}.hero__visual{display:none}}
...
<section class="lp-section alt">
  <div class="lp-section-inner">
    ...
    <div class="test-grid">
      <div class="test-card"><p class="test-card__text">A <?php echo View::e($_nome); ?> nos deu todo o suporte quando enfrentamos um incidente crítico. Na época tínhamos todo o data center on-premise interno, e agora toda nossa infraestrutura está com eles. Nossa parceria já tem mais de 2 anos e a ideia é continuar por muito tempo. Estamos muito felizes com o atendimento prestado.</p><div class="test-card__author"><div class="test-card__av">ES</div><div><div class="test-card__name">Edson Souza</div><div class="test-card__role">Gerente de Tecnologia — Ipanema Queijos</div></div></div></div>
      <div class="test-card"><p class="test-card__text">A <?php echo View::e($_nome); ?> é a principal fornecedora de tecnologia da Akahosting. Fundamentamos uma parceria e em menos de um ano conseguimos ver o extremo sucesso em nossa operação. Graças a eles nossa empresa conseguiu alavancar muito os negócios. Somos gratos pelo suporte em todas as ocasiões.</p><div class="test-card__author"><div class="test-card__av">MP</div><div><div class="test-card__name">Marcio Polonio</div><div class="test-card__role">CEO — Akahosting</div></div></div></div>
      <div class="test-card"><p class="test-card__text">Trabalhávamos com provedores de servidor fora do Brasil, conhecemos a <?php echo View::e($_nome); ?> e trouxemos toda nossa infraestrutura para cá. Estamos com eles há alguns anos e nossa evolução conjunta é constante. Estamos muito satisfeitos e planejamos estender essa parceria cada vez mais.</p><div class="test-card__author"><div class="test-card__av">LB</div><div><div class="test-card__name">Leonardo Barros</div><div class="test-card__role">Diretor Executivo — Reposit</div></div></div></div>
      <div class="test-card"><p class="test-card__text">A migração para a <?php echo View::e($_nome); ?> foi decisiva para nossa operação. O processo foi transparente, o time técnico sempre disponível e o desempenho superou nossas expectativas. Com o servidor dedicado reduzimos latência e aumentamos capacidade sem aumentar os custos.</p><div class="test-card__author"><div class="test-card__av">RN</div><div><div class="test-card__name">Rafael Neves</div><div class="test-card__role">CTO — TechStream</div></div></div></div>
    </div>
  </div>
</section>
