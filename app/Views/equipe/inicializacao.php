  ...
  <div style="margin-top:16px;border-top:1px solid #e5e7eb;padding-top:14px;">
    ...
    <div class="grid" style="grid-template-columns:repeat(auto-fit,minmax(240px,1fr));">
      ...
      <form method="post" action="/equipe/inicializacao/backup-automatico" class="card-new" style="margin:0;">
        <input type="hidden" name="_csrf" value="<?php echo View::e(\LRV\Core\Csrf::token()); ?>" />
        <div class="texto" style="margin:0 0 10px 0;"><strong><svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg> Backup automático (24h)</strong></div>
