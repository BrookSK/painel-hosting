...
<?php if ($webmailUrl !== ''): ?>
  <div style="margin-bottom:16px;">
    <a href="<?php echo View::e($webmailUrl); ?>" target="_blank" rel="noopener" class="botao ghost sm"><svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg> <?php echo I18n::t('eq_emails.abrir_webmail'); ?></a>
  </div>
<?php endif; ?>
