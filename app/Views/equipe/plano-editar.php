  ...
  <form method="post" action="/equipe/planos/salvar">
    ...
    <?php
      $planTypes = [
        ...
        'nodejs'    => ['<svg xmlns="http://www.w3.org/2000/svg" style="width:18px;height:18px;vertical-align:middle;" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1.5l9.5 5.5v11L12 23.5 2.5 18V7z"/></svg> Node.js App', 'Apenas Node.js, banco de dados, domínios e git deploy.'],
