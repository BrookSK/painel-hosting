    ...
    BASH;
        ...
        return [
            ...
            [
                ...
                'cmd'            => 'export DEBIAN_FRONTEND=noninteractive; (which php8.3 >/dev/null 2>&1 && echo "php8.3 ok" || (apt-get install -y -qq php8.3-fpm php8.3-mysql php8.3-curl php8.3-mbstring php8.3-xml php8.3-zip php8.3-gd php8.3-intl 2>&1)) && (which php8.2 >/dev/null 2>&1 && echo "php8.2 ok" || (apt-get install -y -qq php8.2-fpm php8.2-mysql php8.2-curl php8.2-mbstring php8.2-xml php8.2-zip php8.2-gd php8.2-intl 2>&1 || echo "php8.2 skip")) && (which php8.1 >/dev/null 2>&1 && echo "php8.1 ok" || (apt-get install -y -qq php8.1-fpm php8.1-mysql php8.1-curl php8.1-mbstring php8.1-xml php8.1-zip php8.1-gd php8.1-intl 2>&1 || echo "php8.1 skip")); for svc in php8.3-fpm php8.2-fpm php8.1-fpm; do systemctl enable $svc 2>/dev/null; systemctl start $svc 2>/dev/null; done; echo lrv-phpfpm-ok',
